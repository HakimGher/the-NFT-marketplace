   ...
   <div class="flex flex-wrap justify-between items-center mob:px-0 mob:py-4 px-32 py-6 sm:px-16 sm:justify-between md:px-16">
    ...
    <!--  end icons div-->
     ...
     <div style="transition: all 10s;" id="navShow" class="hidden  w-full ml:space-x-14 items-center ml:inline-block ml:w-auto ml:my-auto mob:pt-4  text-center mob:border-t-2 mob:border-borderWhite mob:border-solid mob:header-border mob:mt-4 mob:space-y-3">
       <a class=" nav_btn mob:text-3xl text-6/3xl hover:text-bleu delay-150  " href="#">Home</a>
       <a class=" nav_btn mob:text-3xl text-6/3xl hover:text-bleu delay-150  " href="#">Produits</a>
       <a class=" nav_btn mob:text-3xl text-6/3xl hover:text-bleu delay-150 " href="#">Contact</a>
       <a class=" nav_btn mob:text-3xl text-6/3xl hover:text-bleu delay-150 " href="#">About</a>
      <div class="guest flex space-x-4  mod:w-fit mod:mx-auto  my-4 ml:hidden">
      <button class=" text-2xl py-4 px-6 mob:py-2 mob:px-4 mob:mx-auto bg-bleu font-semibold tracking-wider rounded" type="button">
       Login</button>     
       <button class="btn2 text-2xl py-4 px-6 mob:py-2 mob:px-4 relative border border-white font-semibold tracking-wider overflow-hidden hover:text-bleu  rounded" type="button">
     ...
     <button class="text-2xl py-4 px-6  bg-bleu font-semibold tracking-wider rounded" type="button">
      Login</button>     
     <button class="btn2 text-2xl py-4 px-6 relative border border-white font-semibold tracking-wider overflow-hidden hover:text-bleu  rounded" type="button">
        <span class="absolute inset-0 bg-white"></span>
      <span class="absolute inset-0 flex justify-center items-center font-semibold"> 
        Register
      </span>
